...
// Switched to standard dB default ranges
...
const StartSessionModal = ({
    ...
    // Adjusted validation for standard decibel limits instead of ADC
                ...
                <form className="space-y-5 px-6 py-5 md:px-7 md:py-6" onSubmit={handleSubmit}>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-4">
                        <div className="mb-3 flex items-center gap-2">
                            ...
                            <p className="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Threshold Configuration (dB Level)</p>
                        </div>
