...
urlpatterns = [
    ...
    path('device-config/calibrate', views.calibrate_device_config, name='device_config_calibrate_no_slash'),
    path('device-config/calibrate/', views.calibrate_device_config, name='device_config_calibrate'),
    ...
    path('sessions', views.list_sessions, name='list_sessions_no_slash'),
